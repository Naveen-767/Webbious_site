...
import { 
  FaReact, FaPython, FaJs, FaAws, FaGit, FaAndroid, FaNodeJs, FaHtml5, FaCss3Alt 
} from "react-icons/fa";
import { 
...
function Page() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center bg-white h-[80vh] w-screen  px-4">
